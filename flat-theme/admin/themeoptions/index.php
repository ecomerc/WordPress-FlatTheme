...
if( !defined('ADMIN_PATH') )
	define( 'ADMIN_PATH', get_template_directory() . '/admin/themeoptions/' );
if( !defined('ADMIN_DIR') )
	define( 'ADMIN_DIR', get_template_directory_uri() . '/admin/themeoptions/' );

define( 'ADMIN_IMAGES', ADMIN_DIR . 'assets/images/' );
define( 'ZEE_IMAGES', get_template_directory_uri() .'/assets/images/img/' );
