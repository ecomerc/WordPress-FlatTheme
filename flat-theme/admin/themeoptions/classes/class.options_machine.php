...
//print_r($default_settings['google_fonts']); die;

                    /* Font Size */
                    
                    if( isset($default_settings['size']) and isset($typography_stored['size'])) {
                    ...
                    /* Line Height */
                    if(  isset($default_settings['height']) and  isset($typography_stored['height'])) {
                    ...
                    /* Font Face */
                    if(   isset($default_settings['face']) and   isset($typography_stored['face'])) {
                    ...
                    /* Font Weight */
                    if( isset($default_settings['style']) and isset($typography_stored['style'])) {
                    ...
                    /* Font Color */
                    if(  isset($default_settings['color']) and  isset($typography_stored['color'])) {
                    ...
                    /* Google font */
                    if(  isset($default_settings['google_fonts']) ) {

                
                        
                        $fonts_set =  $default_settings['google_fonts'];



                        $output .= '<div class="select_wrapper typography-style">';
                        $output .= '<select class="select of-input google_font_select" name="'.$value['id'].'[face]" id="'. $value['id'] .'">';




                        foreach ($fonts_set['fonts'] as $select_key => $option) {
                              $output .= '<option value="'.$select_key.'" ' 
                              . selected((isset( $smof_data[$value['id']]['face'] )) ? $smof_data[$value['id']]['face'] : "", $option, false) 
                              . ' />'
                              . $option
                              .'</option>';
                        } 
                        ...
                        if(isset($fonts_set['preview_text'])){
                            $g_text = $fonts_set['preview_text'];
                        } else {
                            $g_text = '0123456789 ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz';
                        }
                        if(isset($fonts_set['preview_size'])) {
                            $g_size = 'style="font-size: '. $fonts_set['preview_size'] .';"';
                        } else { 
                            $g_size = '';
                        }
                        $hide = " hide";
